    ...
    <div>
        ...
        <div class="flex justify-between items-center">
            <div class="flex items-center gap-5">
                <a href="{{ route('land-charges') }}" class="text-[18px] text-[#190FDB] font-bold pb-[11px] mb-[40px] border-b-[2px] inline-block  border-[#190FDB] relative ">Land charges</a>
                <a href="{{ route('port-charges') }}" class="text-[18px] text-[#2E2E2E] font-bold pb-[11px] mb-[40px] inline-block  relative ">Port Charges</a>
            </div>

            <div class="flex justify-end items-center gap-2 mb-5">
                <div class="flex justify-center items-center border-[3px] border-[#C2C2C2] hover:border-[#565AFF] rounded-[6px] h-[46px] w-[46px] group transition-all duration-500 cursor-pointer" wire:click="exportLandCharges">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                            ...
                            @foreach($landCharges as $landCharge)
                                <tr>
                                    ...
                                    <td class="px-3 py-4 text-sm text-gray-500">
                                        <span class="status {{ \Carbon\Carbon::parse($landCharge->expire_date)->isPast() ? 'status-inactive' : 'status-active' }}">
                                            {{ \Carbon\Carbon::parse($landCharge->expire_date)->isPast() ? 'Expirado' : 'Vigente' }}
                                        </span>
                                    </td>
                                    ...
                                    <td>
                                        <div class="flex gap-5">
                                            <div class="cursor-pointer" @click="modalView = true" wire:click="editLandCharge({{ $landCharge->id }})">
                                            ...
                                            <div class="cursor-pointer" @click="modalEdit = true" wire:click="editLandCharge({{ $landCharge->id }})">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="17" height="16" viewBox="0 0 17 16" fill="none">
                                    ...
                                    <div class="inline-block min-w-full py-2 align-middle sm:px-6 lg:px-8">
                                        <div class="col-span-full">
                                            ...
                                            <div class="flex justify-center gap-5">
                                                ...
                                                <a wire:click="uploadLandCharges" class="mt-4 bg-[#565AFF] text-white px-4 py-2 rounded inline-block cursor-pointer">Cargar</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
