    ...
    <div>
        ...
        <div class="flex justify-between items-center">
            ...
            <div class="flex justify-end items-center gap-2 mb-5">
                <div class="flex justify-center items-center border-[3px] border-[#C2C2C2] hover:border-[#565AFF] rounded-[6px] h-[46px] w-[46px] group transition-all duration-500 cursor-pointer" wire:click="exportPortCharges">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                            ...
                            @foreach($portCharges as $portCharge)
                                <tr>
                                    ...
                                    <td class="px-3 py-4 text-sm text-gray-500">
                                        <span class="status {{ \Carbon\Carbon::parse($portCharge->expire_date)->isPast() ? 'status-inactive' : 'status-active' }}">
                                            {{ \Carbon\Carbon::parse($portCharge->expire_date)->isPast() ? 'Expirado' : 'Vigente' }}
                                        </span>
                                    </td>
                                    <td class="px-3 py-4 text-sm text-gray-500">{{ $portCharge->external_notes }}</td>
                                    <td>
                                        <div class="flex gap-5">
                                            <div class="cursor-pointer" @click="modalView = true" wire:click="editPortCharge({{ $portCharge->id }})">
                                            ...
                                            <div class="cursor-pointer" @click="modalEdit = true" wire:click="editPortCharge({{ $portCharge->id }})">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="17" height="16" viewBox="0 0 17 16" fill="none">
                            ...
                            <div class="grid grid-cols-3 gap-5 items-center mb-5">
                                ...
                                <div>
                                    ...
                                    <select id="service_type" wire:model="service_type"  class="mt-2 block w-full rounded-md border-gray-300 py-1.5 pl-3 pr-10 text-gray-900 focus:ring-indigo-600 focus:border-indigo-600 sm:text-sm sm:leading-6">
                                        ...
                                        <option value="PortDestinationCharges">Port Destination Charges</option>
                                    </select>
                                    ...
                                    <div class="inline-block min-w-full py-2 align-middle sm:px-6 lg:px-8">
                                        <div class="col-span-full">
                                            ...
                                            <div class="flex justify-center gap-5">
                                                ...
                                                <a wire:click="uploadPortCharges" class="mt-4 bg-[#565AFF] text-white px-4 py-2 rounded inline-block cursor-pointer">Cargar</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
        ...
        <div class="fixed inset-0 z-10 w-screen overflow-y-auto">
            <div class="flex min-h-full items-end justify-center p-4 text-center sm:items-center sm:p-0">
                ...
                <div class="relative transform overflow-hidden rounded-lg bg-white px-4 pb-4 pt-5 text-left shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-[800px] sm:p-6"  @click.away="modalEdit = false">
                    <div>
                        <div>
                            <form wire:submit="updatePortCharge">
                                <div class="grid grid-cols-3 gap-5 items-center mb-5">
                                    <div>
                                        <label for="product_type" class="block text-sm font-medium text-gray-700">Tipo de producto</label>
                                        <select id="product_type" wire:model="product_type" class="mt-2 block w-full rounded-md border-gray-300 py-1.5 pl-3 pr-10 text-gray-900 focus:ring-indigo-600 focus:border-indigo-600 sm:text-sm sm:leading-6">
